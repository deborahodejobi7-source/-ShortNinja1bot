"""
ShortNinja1bot - A Telegram URL Shortener Bot
Shortens URLs using the TinyURL API.
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        "Welcome to **ShortNinja1bot** - your lightning-fast URL shortener!\n\n"
        "📌 **How it works:**\n"
        "1. Send me any long URL\n"
        "2. I'll shorten it instantly with TinyURL\n"
